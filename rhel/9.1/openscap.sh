...
sudo oscap xccdf eval --remediate --profile xccdf_org.ssgproject.content_profile_standard ssg-ubuntu2204-ds-1.2.xml --report /tmp/openscap_ubuntu2204_report.html
